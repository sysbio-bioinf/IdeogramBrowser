...
public class Locus implements Comparable<Locus> {
	...
	/*
	 * void setChromosome( Byte b ) { chromosome=b; chromosome = 0; if(
	 * str.equalsIgnoreCase("X") ) { chromosome = 23; return; } if(
	 * str.equalsIgnoreCase("Y") ) { chromosome = 24; return; }
	 * 
	 * try { chromosome = Byte.parseByte(str); } catch( NumberFormatException e
	 * ) { } }
	 */

	/*
	 * Byte getChromosome() { return chromosome; if( chromosome >= 1 ||
	 * chromosome <= 22 ) return Integer.toString(chromosome);
	 * 
	...
	/*
	 * public Object clone() { return (Object)new Locus(this); }
	 */

	/**
	 * 
	 * @param locus
	 * @return True if this locus builds a non-empty intersection with the given
	 *         locus.
	 */
