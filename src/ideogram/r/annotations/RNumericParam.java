...
public @interface RNumericParam {
    ...
    /**
     * Labels the corresponding input fields in the GUI shall have. Default:
     * RNumeric.
     */
    ...
    /**
     * Specify whether this field expects input for boolean vectors. If this is
     * set to true, multiple values separated by commas may be inserted.
     * Default: false.
     * 
     * @return
     */
