 ...
 * 
 */
public class DefaultMessageDisplayModel extends Observable implements
	MessageDisplay {

    private static DefaultMessageDisplayModel instance = new DefaultMessageDisplayModel();
