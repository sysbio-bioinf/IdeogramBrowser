...
public interface RInterfaceBuilder {
     ...
     * is called again. One {@link RLibraryWrapper} may provide more than one
     * analysis function. Each analysis function should then receive an analysis
