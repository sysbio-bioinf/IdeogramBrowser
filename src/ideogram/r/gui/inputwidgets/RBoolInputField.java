...
public class RBoolInputField extends JComboBox implements RInputWidget {
    ...
    /*
     * Select the default value. Mark the box as not mandatory. If there is no
     * defaultvalue, or the default value is invalid, set defaultValue to "" and
     * mark the box as mandatory. No item will be selected in the combo box.
     */
