...
public interface RInputWidget {
    ...
    /**
     * Reference to a class, which is able to display status messages. Set to
    ...
    /**
     * Reset the input field to its default value. This also assures, that the
     * corresponding input field of the underlying {@link RLibraryWrapper} will
     * be set to its default value. Note, that this does not have to happen
