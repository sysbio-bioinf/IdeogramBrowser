...
public class RNumericInputField extends AbstractRInputField {
    ...
    private static final String MDP_TEXT = "This fields accepts only numeric values!";
     ...
     * <li>a comma separated list of numeric values, if the underlying R
     * function expects an vector</li>
     * </ul>
