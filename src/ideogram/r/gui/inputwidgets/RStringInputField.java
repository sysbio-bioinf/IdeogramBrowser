...
/**
 * Input field for R strings. The surrounding single quotes (') needed by R will
 * be removed, before the string gets displayed. They will be added, before the
 * string is stored into the corresponding public field in the wrapper class.
 * 
...
public class RStringInputField extends AbstractRInputField {
	...
	if (isMandatory() && getText().length() == 0)
	    return false;
